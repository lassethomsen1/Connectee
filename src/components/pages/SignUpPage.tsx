            ...
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                <div className="text-center">
                    ...
                    <div className="mt-5 space-y-2">
                        ...
                        <p className=""> Already have an account? <a href="/login" className="font-medium text-primary hover:text-indigo-500">Login</a></p>
                    </div>
                </div>
                <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    <div className="grid grid-cols-3 gap-x-3">
                        ...
                        <button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100" onClick={signInWithGithub}>
                            <GithubIcon/>
                        </button>
                    </div>
